...
装一堆插件/扩展，用 [Settings Sync](https://juejin.im/post/5cd933e5e51d456e39631997) 管理很方便。 配置 & 快捷键，<i class="fas fa-external-link-alt"></i>&nbsp; [VS Code 功夫](/posts/vscode/)
...
Chrome 的配置和插件用 Google Sync 来管理很方便，<i class="fas fa-external-link-alt"></i>&nbsp; [Chrome 功夫](/posts/chrome/)
