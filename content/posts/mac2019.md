...
-   Paralles Desktop：Windows 虚拟机，读写 NTFS，USB 外挂大硬盘必备，发现 Paragon NTFS 或者 Tuexra NTF，移动文件过程中会出现文件莫名其妙的失踪，只好采取这个比较迂回的办法 ！
-   PopClip：copy & paste
-   SnagIt：截屏、 编辑
...
常用快捷键参考 <i class="fas fa-external-link-alt"></i>&nbsp;&nbsp; [命令行功夫](/posts/cmd/)
