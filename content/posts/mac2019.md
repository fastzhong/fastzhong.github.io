...
# brew
alias b="brew"
alias brew-ls="brew list --versions"
alias brew-up='echo "updating brew formulas and casks ....."; brew update; brew outdated --verbose; brew upgrade; brew cleanup; brew doctor --verbose; brew outdated --cask --verbose; brew upgrade --cask; brew doctor --verbose'
alias c="clear"
alias cat="bat"
...
alias dota='/usr/bin/git --git-dir=$HOME/.mdot/ --work-tree=$HOME add'
alias dotc='/usr/bin/git --git-dir=$HOME/.mdot/ --work-tree=$HOME commit -a -m'
alias dotp='/usr/bin/git --git-dir=$HOME/.mdot/ --work-tree=$HOME push -u origin master'
alias dots='/usr/bin/git --git-dir=$HOME/.mdot/ --work-tree=$HOME status'
...
alias npm-up='echo "updating node global modules ......"; npm cache verify; npm outdated -g; npm update -g'
...
alias pip-up='echo "updating all python packages ....."; sudo pip install -U pip && pip freeze --local | grep -v "^\-e" | cut -d = -f 1  | xargs pip install -U; rm ~/.pip/cache/*'
alias q="exit"
alias rg="ripgrep"
alias rd="rmdir"
alias gem-up='echo "updating ruby gems ....."; sudo gem update --system && gem cleanup'
### ssh
alias s="ssh"
alias ssh-ls="grep 'Host ' .ssh/config | awk '{print $2}' | sort -h"
### terraform
alias t="terraform"
alias top="htop"
alias v="vagrant"
