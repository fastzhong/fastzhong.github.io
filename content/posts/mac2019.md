...
不得不吐槽，Apple 家的 ⌨️ 🖱️ 我极不习惯（用过至少两代了），键盘换成了 [K1 Bluetooth](https://www.keychron.com/products/keychron-k1-wireless-mechanical-keyboard)：

![K1 Bluetooth](/images/mac2019/k1_keyboard.jpg)
...
![Logi MX Master3](/images/mac2019/mx-master-3.png)

![Logi MX Master3 Settings](/images/mac2019/mx-master-settings.png)
...
-   Keyboard
    ...
    - 功能键 Fn：默认情况下，F1-F12都是特殊功能，比如调节屏幕亮度。而当你需要键入F1-F12时需要同时按住Fn，这对于开发人员来说是非常不方便的。将F1-F12改成标准功能键。

    - 键盘控制：上图里选 Shortcuts，然后 ☑️User keyboard navigation to move focus between controls

    - Caps 切换输入法

![Keyboard](/images/mac2019/keyboard.png)

-   Dock

![Dock](/images/mac2019/dock.png)

### Finder

Finder -> Preference -> Advanced:  
![Finder Advanced](/images/mac2019/Finder-Advanced.png)

Finder -> View -> Show View Options:  
![Finder View Options](/images/mac2019/Finder-ViewOptions.png)
...
-   Paralles Desktop：Windows 虚拟机，读写 NTFS，USB 外挂大硬盘必备
    -   发现 Paragon NTFS 或者 Tuexra NTF, 移动文件过程中会出现文件莫名其妙的失踪，只好采取这个比较迂回的办法 ！
    -   Windows 对 MBP 的 Retina 的支持不好，DPI 不可以超过 185%，参见 [Resize Search Box and Address Box Win7](https://answers.microsoft.com/en-us/windows/forum/all/resize-search-box-and-address-box-win7/6b5e4b98-e74d-4f9e-8392-05177c113851?tab=AllReplies#tabs)
-   PopClip：copy & paste
-   SnagIt：截屏、 编辑
...
具体使用参考 <i class="fas fa-external-link-alt"></i>&nbsp;&nbsp; [IntelliJ 功夫](/posts/intellij/)

### Visual Studio Code

装一堆插件/扩展，用 [Settings Sync](https://juejin.im/post/5cd933e5e51d456e39631997) 管理很方便。

#### 配置 & 快捷键

具体使用参考 <i class="fas fa-external-link-alt"></i>&nbsp;&nbsp; [VS Code 功夫](/posts/vscode/)
...
-   zsh-syntax-highlighting  
    ![syntax-highlight](/images/mac2019/zsh-syntaxhighlight.png)

-   zsh-autosuggestions  
    ![autosuggestions](/images/mac2019/zsh-autosuggestion.gif)

-   zsh-history-substring-search  
    ![substring search](/images/mac2019/zsh-substring.gif)

命令行提示符配置，OMZ Theme 自带的和那个 Powerlevel10K 太眼花缭乱，这个简约：[spaceship](https://denysdovhan.com/spaceship-prompt/)。

有许多增强型命令行工具，并善用命令行的 alias，例如：

-   ag/ripgrep：取代 grep
    ![ag](/images/mac2019/ag.jpeg)
...
-   jq：json 文件浏览、格式化、支持高亮
    ![jq](/images/mac2019/shellcheck.webp)

-   psgrep
-   pstree
-   shellcheck：shell script 语法检查
    ![shellcheck](/images/mac2019/shellcheck.webp)

*   thefuck
*   tig
*   tldr：取代 man
    ![tldr](/images/mac2019/tldr.webp)
*   xz：压缩工具
...
把 `bindkey -v` 加到 .zshrc 里，命令行就可以用 vi 的快捷键（ `bindkey -e` 则是 emacs）。常用快捷键参考 <i class="fas fa-external-link-alt"></i>&nbsp;&nbsp; [命令行功夫](/posts/cmd/)
...
![iTerm2](/images/mac2019/iterm2-hotkey1.png)

![iTerm2](/images/mac2019/iterm2-hotkey2.jpg)
