...
Go 不是一种“颠覆性”的，而更多是“优选性”的编程语言：

-   feature-simplicity from C
-   readability from Python
-   static-typed & compiled like C++/Java and fast as compiled language 
-   GC from Java
-   language built-in concurrency：goroutines

想了解的可以参考：[Why Go Is Successful (aka Simplicity is Complicated)](https://www.youtube.com/watch?v=k9Zbuuo51go)
...
💡 GOPATH 简单，但难以处理版本依赖和隔离，Go1.14 后推荐使用 Go Module（类似 pip/npm/maven，Go 语言的依赖解决方案），取代 GOPATH
